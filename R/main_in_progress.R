## downlaod and load the necessary packages ====================================
##==============================================================================
list_of_packages = c("data.table", # scalegram_main()
                     "parallel", # scalegram_main()
                     "e1071", # scalegram_main()
                     "Lmoments", # scalegram_main()
